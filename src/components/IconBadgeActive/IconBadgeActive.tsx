...
const IconBadgeActive = ({ size = 16 }: IconProps) => {
    ...
    <path d="M12.3529 5H12.3529C11.4432 5 10.7058 5.73741 10.7058 6.64706V6.64707C10.7058 7.55672 11.4432 8.29413 12.3529 8.29413H12.3529C13.2625 8.29413 13.9999 7.55672 13.9999 6.64707V6.64706C13.9999 5.73741 13.2625 5 12.3529 5Z" fill="#1DBC7B"/>
    </svg>    
    ;
...
export default IconBadgeActive;