...
const IconCollapse = ({ size = 16 }: IconProps) => {
    ...
    <path d="M7.26319 8.26315H3.57898V8.78947H7.26319V8.26315Z" fill="#D5DFEB"/>
    <path d="M8.84214 9.3158H3.57898V9.84211H8.84214V9.3158Z" fill="#8692A3"/>
    <path d="M7.78951 10.3684H3.57898V10.8947H7.78951V10.3684Z" fill="#D5DFEB"/>
